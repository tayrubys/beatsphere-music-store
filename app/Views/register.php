...
<?= $this->section('icerik') ?>
    ...
    <style>
        ...
        /* Görseldeki Derin Lacivert Renk Geçişi */
        .register_box_img { background: linear-gradient(135deg, #141E30 0%, #243B55 100%); color: white; text-align: center; height: 100%; display: flex; align-items: center; justify-content: center; padding: 50px; border-radius: 0 10px 10px 0; }
        .register_box_img h4 { color: white; font-weight: bold; margin-bottom: 20px; }
        
        /* Şeffaf Çerçeveli Buton */
        .button-account { border: 1px solid white; background: transparent; color: white; padding: 10px 30px; border-radius: 5px; text-decoration: none; transition: 0.3s; display: inline-block; margin-top: 20px;}
        .button-account:hover { background: white; color: #141E30; }
        
        /* Beyaz Form Alanı */
        .login_form_inner { padding: 50px; border: 1px solid #eee; border-radius: 10px 0 0 10px; height: 100%; box-shadow: 0 0 15px rgba(0,0,0,0.05); }
        ...
        /* Koyu Gri/Lacivert Form Butonu (Görseldeki gibi) */
        .button-register { background: #2c3e50; color: white; border: none; padding: 12px; border-radius: 5px; font-weight: bold; transition: 0.3s; }
        .button-register:hover { background: #1a252f; color: white; }
    </style>
            ...
            <div class="row align-items-stretch flex-row-reverse">
                ...
                <div class="col-lg-6 pe-lg-0">
                    <div class="login_form_inner bg-white">
                        ...
                        <form class="row login_form" action="#" method="post" id="registerForm">
