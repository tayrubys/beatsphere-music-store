        ...
        <nav class="navbar navbar-expand-lg navbar-light py-3">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <?php if (session()->get('giris_yapildi') && session()->get('rol') == 'admin'): ?>

                        <!-- ADMIN NAVBAR -->
                        <ul class="navbar-nav mx-auto">

                            <li class="nav-item mx-2">
                                <a class="nav-link admin-nav-link" href="<?= base_url('admin') ?>">
                            ...
                            <li class="nav-item mx-2">
                                <a class="nav-link admin-nav-link" href="<?= base_url('admin/urunler') ?>">
                                    <i class="fa-solid fa-record-vinyl me-1"></i>
                                    Ürün Yönetimi
                                </a>
                            </li>
                            <li class="nav-item mx-2">
                               <a class="nav-link admin-nav-link" href="<?= base_url('admin/kullanicilar') ?>">
                                   <i class="fa-solid fa-users me-1"></i>
                                   Kullanıcı Yönetimi
                                </a>
                            </li>
                            <li class="nav-item mx-2">
                                <a class="nav-link admin-nav-link" href="<?= base_url('admin/siparisler') ?>">
                            ...
                            <li class="nav-item mx-2">
                                <a class="nav-link admin-nav-link" href="<?= base_url('/') ?>">
...
<a class="dropdown-item fw-bold" href="<?= base_url('admin/profil') ?>" style="color: #141E30;">
    ...
    Profilim / Hesabım
                    ...
                    <?php else: ?>
                        ...
                        <!-- NORMAL KULLANICI / ZİYARETÇİ NAVBAR -->
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item mx-2">
                                <a class="nav-link" href="<?= base_url('hakkimizda') ?>">
                                    Hakkımızda
                                </a>
                            </li>
                            ...
                            <li class="nav-item dropdown mx-2">
                                ...
                                <ul class="dropdown-menu border-0 shadow-sm">
                                    <li>
                                        <a class="dropdown-item" href="<?= site_url('kategori/1') ?>">
                                            Pop
                                        </a>
                                    </li>

                                    <li>
                                        <a class="dropdown-item" href="<?= site_url('kategori/2') ?>">
                                            Rock
                                        </a>
                                    </li>

                                    <li>
                                        <a class="dropdown-item" href="<?= site_url('kategori/3') ?>">
                                            R&B
                                        </a>
                                    </li>

                                    <li>
                                        <a class="dropdown-item" href="<?= site_url('kategori/4') ?>">
                                            K-pop
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <ul class="nav-shop d-flex align-items-center list-unstyled mb-0">
                            ...
                            <li>
                                <button onclick="window.location.href='<?= base_url('sepet') ?>'"
                                        title="Sepetim">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="single-footer-widget">
                        <h4>Biz Kimiz?</h4>
                        <p>
                            BeatSphere, dünya müziğinin en sevilen albümlerini kolayca bulup keşfedebileceğiniz modern ve kullanıcı dostu bir albüm satış platformudur.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-12 mb-4">
                    <div class="single-footer-widget">
                        ...
                        <p>
                            ...
                            Kocaeli, Türkiye <br>
                            Teknoloji Fakültesi Bilişim Sistemleri
                        </p>
                        ...
                        <p class="mt-4" style="color:#aaa; font-size:0.9rem;">
                            ...
                            Bu web sitesi:
                            <strong class="text-white">Şevval Ceren Yıldız</strong>
        ...
        <div class="footer-bottom">
            <div class="container">
                <p class="mb-0 text-center">
                    © <?= date('Y') ?> BeatSphere Albüm Satış Sitesi – Tüm Hakları Saklıdır.
                </p>
            </div>
        </div>
    </div>
